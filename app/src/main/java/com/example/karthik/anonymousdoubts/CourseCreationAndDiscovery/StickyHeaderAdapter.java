...
public class StickyHeaderAdapter<Item extends IItem> extends RecyclerView.Adapter implements StickyRecyclerHeadersAdapter {
    ...
    public long getHeaderId(int position) {
        ...
        if (item instanceof CourseMetaDataView && ((CourseMetaDataView) item).header != null) {
            return ((CourseMetaDataView) item).header.charAt(0);
        }
    ...
    public RecyclerView.ViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.coursediscovery_view_header, parent, false);
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (item instanceof CourseMetaDataView && ((CourseMetaDataView) item).header != null) {
            ...
            textView.setText(String.valueOf(((CourseMetaDataView) item).header));
        }
